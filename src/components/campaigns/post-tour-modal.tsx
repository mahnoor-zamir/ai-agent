...
export function PostTourModal({ isOpen, onClose, onSave }: PostTourModalProps) {
  ...
  const handleSave = () => {
    ...
    toast({
      ...
      description: "Your post-tour message automation has been updated.",
    })
  }
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[700px] h-[80vh] p-6 overflow-hidden">
        <DialogHeader className="p-6 pb-2">
          <DialogTitle className="text-2xl font-bold">Configure Post-Tour Message</DialogTitle>
          <DialogDescription>
            Set up when to send the post-tour message and customize the content.
          </DialogDescription>
        </DialogHeader>
              ...
              <TabsContent value="edit" className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="border rounded-md p-2 space-y-2">
                    ...
                    <Textarea
                      id="message"
                      placeholder="Enter your post-tour message..."
                      value={message}
