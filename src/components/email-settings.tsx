...
export function EmailSettings() {
  ...
  const [followUpTemplates, setFollowUpTemplates] = useState<{ content: string; schedule: string }[]>([
    { content: "", schedule: "3" },
    { content: "", schedule: "7" },
    { content: "", schedule: "14" },
    { content: "", schedule: "30" },
                  ...
                  <div className="space-y-2">
                    {reminders.map((reminder, index) => (
                      <div key={reminder.id} className="flex items-center space-x-2">
                        <Select
                          value={reminder.days}
                          onValueChange={(value) => updateReminder(reminder.id, value)}
                        >
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    {googleAdsConnected ? (
                      ...
                      <div className="space-x-2">
                        <Badge variant="secondary" className="bg-red-100 text-red-800">Not Connected</Badge>
                        <Button onClick={() => handleConnectMarketing("google")}>Connect Google Ads</Button>
                      </div>
                    )}
                  </div>
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Connect your Meta Ads account</p>
                    </div>
                    {metaAdsConnected ? (
                      <Badge variant="secondary" className="bg-green-100 text-green-800">Connected</Badge>
                    ) : (
                      <div className="space-x-2">
                        <Badge variant="secondary" className="bg-red-100 text-red-800">Not Connected</Badge>
                        <Button onClick={() => handleConnectMarketing("meta")}>Connect Meta Ads</Button>
                      </div>
                    )}
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    {googleAnalyticsConnected ? (
                      ...
                      <div className="space-x-2">
                        <Badge variant="secondary" className="bg-red-100 text-red-800">Not Connected</Badge>
                        <Button onClick={() => handleConnectMarketing("analytics")}>Connect Google Analytics</Button>
                      </div>
                    )}
                  </div>
                </div>
